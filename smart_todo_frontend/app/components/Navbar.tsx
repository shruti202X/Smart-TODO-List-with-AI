    ...
    <div className="hidden lg:block">
      <ul className="flex flex-col gap-2 mt-2 mb-4 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
        <li className="flex items-center p-1 text-sm gap-x-2 text-slate-600">
          <a href="#" className="flex items-center">Dashboard</a>
        </li>
        <li className="flex items-center p-1 text-sm gap-x-2 text-slate-600">
          <a href="#" className="flex items-center">Tasks</a>
        </li>
        <li className="flex items-center p-1 text-sm gap-x-2 text-slate-600">
          <a href="#" className="flex items-center">Contexts</a>
        </li>
        <li className="flex items-center p-1 text-sm gap-x-2 text-slate-600">
          <a href="#" className="flex items-center">SignUp</a>
        </li>
      </ul>
    </div>
    <button
